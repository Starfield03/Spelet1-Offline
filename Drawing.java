...
public class Drawing {
    ...
    public static int drawNewCircles(SimpleWindow gameboard, int player, int nextPositionX, int nextPositionY){ //Draws new squares
    ...
    public static int drawOldCircles(SimpleWindow gameboard, int player, int activePositionX, int activePositionY){ //Redraws old squares
        if(player == 1){ //Player 1
            Color player1 = new Color(204, 0, 0); //Custom color player 1
            gameboard.setLineColor(player1); //Sets color
        }
        
        else if(player == 2){ //Player 2
            Color player2 = new Color(0, 0, 204); //Custom color player 2
            gameboard.setLineColor(player2); //Sets color
        }
        
        else if(player == 3){ //Player 3
            Color player3 = new Color(0, 204, 0); //Custom color player 3
            gameboard.setLineColor(player3); //Sets color
        }
        
        else{ //Player 4
            Color player4 = new Color(204, 204, 0); //Custom color player 4
            gameboard.setLineColor(player4); //Sets color
        }
    ...
    public static int drawTurn(SimpleWindow gameboard, int sideLength){ //Draws the text: "Turn:"
        gameboard.setLineColor(Color.black); //Sets text color to black
